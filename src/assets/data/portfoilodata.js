const portfolioData = {
  portfolioList: [
    ...
    },
    {
      ...
      description:
        '삼성 갤럭시 탭 S7 페이지를 제작하였습니다. 삼성 솔루션을 사용하였고, 배포하는 과정에서 AEM 시스템을 사용하였습니다. 삼성의 웹 접근성 가이드를 엄격히 준수하여 작업하였습니다.',
    ...
    },
    {
      ...
      description:
        '캐논 Rchive 사이트를 제작하였습니다. 캐논 보안 시스템으로 인해 캐논 본사로 파견을 가서 배포를 진행하였습니다. 다양한 인터렉션으로 GDWEB의 웹 부분에서 대상을 수상하였습니다.',
    ...
    },
    {
      ...
      link: 'https://www.canon-ci.co.kr/rchive/main/index',
      description:
        '기아 AO 2020 이벤트 페이지를 제작하였습니다. 무한히 진행 되는 선 드로잉 애니메이션이 사이트의 메인 컨셉입니다. 모든 페이지에 반영된 애니메이션이 사용자의 흥미를 유발하는 사이트입니다.',
    ...
    },
    {
      ...
      description:
        '위닉스 홈페이지 리뉴얼 작업을 하였습니다. 리뉴얼 작업과 함께 위닉스의 로고와 메인 컬러가 변경되면서 모든 페이지를 제작하였습니다. 관리자 페이지와 연동되어 있습니다.',
    ...
    },
    {
      ...
      description:
        '기아의 셀토스 메인 캠페인 페이지를 제작하였습니다. 기아의 솔루션을 사용하였습니다. 사이트의 컨셉에 맞춰 창의적인 인터렉션을 시도하려고 노력하였습니다.',
      tech: ['Html & CSS', 'Javascript', 'React', 'React-BootStrap', 'Node.JS'],
      image: [
        {
          name: 'kia/main.gif',
          tit: '',
    ...
    },
    {
      ...
      description:
        '삼성 웨어러블 시리즈 글로벌 페이지를 작업하였습니다. 글로벌 사이트라서 중동국가 및 IE8까지 대응하였습니다.',
      tech: ['Html & CSS', 'Javascript'],
      image: [
        {
          name: 'buds/main.gif',
